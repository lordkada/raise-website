      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 w-full grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-8 text-center lg:text-left">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
            <button onClick={openModal} className="group relative px-8 py-4 bg-raise-neon rounded-lg font-bold text-raise-black text-lg hover:bg-raise-yellow transition-all duration-300 shadow-[0_0_20px_rgba(204,255,0,0.4)] overflow-hidden">
